...
class FlexPayGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://api.flexpaybd.com';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $orderId = 'FLEX_' . Str::random(12);

        return new PaymentResponse(true, $orderId, [
            'gatewayTransactionId' => $orderId,
            'data' => ['order_id' => $orderId, 'amount' => $amount, 'currency' => 'BDT', 'status' => 'PENDING']
        ]);
    }
    ...
    {
        throw new \Exception('FlexPay does not support subscriptions');
    }
