...
class PathaoGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://api.pathao.com';
    ...
    {
        throw new \Exception('Pathao does not support subscriptions');
    }
