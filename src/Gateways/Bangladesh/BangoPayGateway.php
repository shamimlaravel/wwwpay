...
class BangoPayGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://api.bangopay.com';
    ...
    {
        throw new \Exception('BangoPay does not support subscriptions');
    }
