...
class AamarPayGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://aamarpay.com';
    ...
    {
        throw new \Exception('AamarPay does not support subscriptions');
    }
