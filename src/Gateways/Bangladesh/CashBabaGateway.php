...
class CashBabaGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://api.cashbaba.com';
    ...
    {
        throw new \Exception('CashBaba does not support subscriptions');
    }
