...
class SSLCommerzGateway implements PaymentGateway
{
    ...
    protected string $baseUrl = 'https://securepay.sslcommerz.com';
        ...
        return new PaymentResponse(
            ...
            [
                ...
                'data' => [
                    ...
                    'status' => 'PENDING',
                    'GatewayPageURL' => "{$this->baseUrl}/gateway/index/{$tranId}",
                ]
            ]
        );
    }
    ...
    {
        return !empty($data['tran_id']) || !empty($data['customer_email']);
    }
    ...
    {
        $subscriptionId = 'SSL_SUB_' . Str::random(12);
    ...
    {
        return isset($request->all()['tran_id']);
    }
}
