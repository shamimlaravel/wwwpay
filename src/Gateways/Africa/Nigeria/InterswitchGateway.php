...
class InterswitchGateway implements PaymentGateway
{
    ...
    protected string $name = 'interswitch';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'ISW_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Interswitch payment initiated',
            'redirect_url' => 'https://paystack.com/interswitch/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Interswitch gateway is configured'];
    }
