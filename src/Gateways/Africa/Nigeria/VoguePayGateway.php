...
class VoguePayGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'voguepay';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'VPG_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'VoguePay payment initiated',
            'redirect_url' => 'https://voguepay.com/pay/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'VoguePay gateway is configured'];
    }
