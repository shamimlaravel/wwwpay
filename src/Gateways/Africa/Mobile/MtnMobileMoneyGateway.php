...
class MtnMobileMoneyGateway implements PaymentGateway
{
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'MTN_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'redirect_url' => 'https://mtn.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'MTN Mobile Money gateway is configured'];
    }
