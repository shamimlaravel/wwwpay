...
class AirtelAfricaGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'airtelafrica';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'AIRTELA_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Airtel Africa payment initiated',
            'redirect_url' => 'https://airtelafrica.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Airtel Africa gateway is configured'];
    }
