...
class OrangeMoneyGateway implements PaymentGateway
{
    ...
    protected string $name = 'orangemoney';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'OM_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'redirect_url' => 'https://orangemoney.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Orange Money gateway is configured'];
    }
