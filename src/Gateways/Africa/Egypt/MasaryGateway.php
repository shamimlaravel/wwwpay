...
namespace ShamimStack\WwwPay\Gateways\Africa\Egypt;
...
class MasaryGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'masary';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'MAS_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Masary payment initiated',
            'redirect_url' => 'https://masary.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Masary gateway is configured'];
    }
