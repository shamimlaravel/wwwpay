...
class RapydGateway implements PaymentGateway
{
    ...
    {
        $transactionId = 'RAPYD_' . Str::random(12);
        ...
        return new PaymentResponse(true, $transactionId, [
            ...
            'returnUrl' => $data['return_url'] ?? url('/payment/callback/rapyd'),
            'status' => 'PENDING',
        ]);
    }
    ...
    {
        return new PaymentResponse(true, 'REF_RAPYD_' . Str::random(12), [
            'gateway' => 'rapyd',
    ...
    {
        return new PaymentResponse(true, $transactionId, ['gateway' => 'rapyd', 'status' => 'CANCELLED']);
    }

    public function verify(array $data): bool { return isset($data['id']); }
    public function getName(): string { return 'rapyd'; }
    public function supportsSubscriptions(): bool { return true; }
    public function subscribe(array $data): \ShamimStack\WwwPay\Contracts\Subscription
    {
        $subscriptionId = 'SUB_RAPYD_' . Str::random(12);
        return new \ShamimStack\WwwPay\Subscriptions\Subscription(
            $subscriptionId, 'rapyd', $data['amount'] ?? 0, 'monthly', 'active'
        );
    }
