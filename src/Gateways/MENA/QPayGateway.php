...
class QPayGateway implements PaymentGateway
{
    ...
    {
        $transactionId = 'QPAY_' . Str::random(12);
        ...
        return new PaymentResponse(true, $transactionId, [
            ...
            'returnUrl' => $data['return_url'] ?? url('/payment/callback/qpay'),
            'status' => 'PENDING',
        ]);
    }
    ...
    {
        return new PaymentResponse(true, 'REF_QPAY_' . Str::random(12), [
            'gateway' => 'qpay',
    ...
    {
        return new PaymentResponse(true, $transactionId, ['gateway' => 'qpay', 'status' => 'CANCELLED']);
    }

    public function verify(array $data): bool { return isset($data['order_id']); }
    public function getName(): string { return 'qpay'; }
