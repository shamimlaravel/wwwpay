...
class TamaraGateway implements PaymentGateway
{
    ...
    {
        $transactionId = 'TAMARA_' . Str::random(12);
        ...
        return new PaymentResponse(true, $transactionId, [
            ...
            'returnUrl' => $data['return_url'] ?? url('/payment/callback/tamara'),
            'status' => 'PENDING',
        ]);
    }
    ...
    {
        return new PaymentResponse(true, 'REF_TAMARA_' . Str::random(12), [
            'gateway' => 'tamara',
    ...
    {
        throw new \Exception('Tamara does not support subscriptions');
    }
