...
class RakutenPayGateway implements PaymentGateway
{
    ...
    protected string $name = 'rakutenpay';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'RAKUTEN_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Rakuten Pay payment initiated',
            'redirect_url' => 'https://checkout.rakuten.co.jp/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Rakuten Pay gateway is configured'];
    }
