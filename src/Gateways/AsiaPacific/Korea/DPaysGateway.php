...
class DPaysGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'dpay';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'DPAY_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'dPay payment initiated',
            'redirect_url' => 'https://dpay.co.kr/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'dPay gateway is configured'];
    }
