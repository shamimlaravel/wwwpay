...
class KakaoPayGateway implements PaymentGateway
{
    ...
    protected string $name = 'kakaopay';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'KAKAO_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'KakaoPay payment initiated',
            'redirect_url' => 'https://kakaopay.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'KakaoPay gateway is configured'];
    }
