...
class TossPayGateway implements PaymentGateway
{
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'TOSS_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'redirect_url' => 'https://pay.toss.im/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Toss gateway is configured'];
    }
