...
class CashfreeGateway implements PaymentGateway
{
    ...
    {
        $transactionId = 'CASHFREE_' . Str::random(12);
        ...
        return new PaymentResponse(true, $transactionId, [
            ...
            'returnUrl' => $data['return_url'] ?? url('/payment/callback/cashfree'),
            'status' => 'PENDING',
        ]);
    }
    ...
    {
        return new PaymentResponse(true, 'REF_CASHFREE_' . Str::random(12), [
            'gateway' => 'cashfree',
    ...
    {
        return new PaymentResponse(true, $transactionId, ['gateway' => 'cashfree', 'status' => 'CANCELLED']);
    }

    public function verify(array $data): bool { return isset($data['order_id']); }
    public function getName(): string { return 'cashfree'; }
    public function supportsSubscriptions(): bool { return true; }
    public function subscribe(array $data): \ShamimStack\WwwPay\Contracts\Subscription
    {
        $subscriptionId = 'SUB_CASHFREE_' . Str::random(12);
        return new \ShamimStack\WwwPay\Subscriptions\Subscription(
            $subscriptionId, 'cashfree', $data['amount'] ?? 0, 'monthly', 'active'
        );
    }
