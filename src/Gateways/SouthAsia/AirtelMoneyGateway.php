...
class AirtelMoneyGateway implements PaymentGateway
{
    ...
    protected string $name = 'airtelmoney';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'AM_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'redirect_url' => 'https://pay.airtel.in/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Airtel Money gateway is configured'];
    }
