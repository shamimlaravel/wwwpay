...
class FreeChargeGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'freecharge';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'FC_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'FreeCharge payment initiated',
            'redirect_url' => 'https://checkout.freecharge.in/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'FreeCharge gateway is configured'];
    }
