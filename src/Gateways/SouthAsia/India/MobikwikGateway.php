...
class MobikwikGateway implements PaymentGateway
{
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'MBK_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Mobikwik payment initiated',
            'redirect_url' => 'https://paywith.mobikwik.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Mobikwik gateway is configured'];
    }
