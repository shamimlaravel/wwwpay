...
class RabbitGateway implements PaymentGateway
{
    use HasPayments;
    ...
    {
        $transactionId = 'RABBIT_' . Str::random(12);
        ...
        return new PaymentResponse(true, $transactionId, [
            ...
            'amount' => $amount,
            'currency' => 'THB',
            'returnUrl' => $data['return_url'] ?? url('/payment/callback/rabbit'),
            'status' => 'PENDING',
        ]);
    }
    ...
    {
        return new PaymentResponse(true, 'REF_RABBIT_' . Str::random(12), [
            'gateway' => 'rabbit',
    ...
    {
        return new PaymentResponse(true, $transactionId, ['gateway' => 'rabbit', 'status' => 'CANCELLED']);
    }
    ...
    {
        throw new \Exception('Rabbit does not support subscriptions');
    }
