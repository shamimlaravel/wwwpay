...
class DANAGateway implements PaymentGateway
{
    use HasPayments;

    protected array $config;
    protected string $baseUrl = 'https://api.dana.id';
    ...
    {
        throw new \Exception('DANA does not support subscriptions');
    }
