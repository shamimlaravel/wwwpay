...
namespace ShamimStack\WwwPay\Gateways\Europe\Portugal;
...
class MultibancoGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'multibanco';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'MB_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Multibanco payment initiated',
            'reference' => $reference,
            'entity' => '12345',
            'gateway' => $this->name,
        ]);
    ...
    {
        return ['success' => true, 'message' => 'Multibanco gateway is configured'];
    }
