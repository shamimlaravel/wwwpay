...
namespace ShamimStack\WwwPay\Gateways\Europe\Austria;
...
class EPSGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'eps';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'EPS_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'EPS payment initiated',
            'redirect_url' => 'https://eps.at/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'EPS gateway is configured'];
    }
