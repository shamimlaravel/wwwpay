...
namespace ShamimStack\WwwPay\Gateways\Europe\Poland;
...
class Przelewy24Gateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'przelewy24';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'P24_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Przelewy24 payment initiated',
            'redirect_url' => 'https://przelewy24.pl/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Przelewy24 gateway is configured'];
    }
