...
class GiropayGateway implements PaymentGateway
{
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'Giro_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Giropay payment initiated',
            'redirect_url' => 'https://giropay.de/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Giropay gateway is configured'];
    }
