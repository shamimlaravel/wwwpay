...
namespace ShamimStack\WwwPay\Gateways\Europe\Germany;
...
class SofortGateway implements PaymentGateway
{
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'SOF_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Sofort payment initiated',
            'redirect_url' => 'https://payment.sofort.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Sofort gateway is configured'];
    }
