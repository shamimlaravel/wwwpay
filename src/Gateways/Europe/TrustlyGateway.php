...
class TrustlyGateway implements PaymentGateway
{
    protected array $config;
    protected string $name = 'trustly';
    ...
    public function pay(array $data): PaymentResponse
    {
        ...
        $transactionId = 'TRU_' . time() . '_' . uniqid();
        ...
        return new PaymentResponse([
            ...
            'status' => 'pending',
            'message' => 'Trustly payment initiated',
            'redirect_url' => 'https://trustly.com/' . $transactionId,
            'gateway' => $this->name,
        ]);
    }
    ...
    {
        return ['success' => true, 'message' => 'Trustly gateway is configured'];
    }
